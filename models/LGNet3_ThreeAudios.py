...
class LGNet3_ThreeAudios(nn.Module):
    def __init__(self, k=1, c_in=40):
        super(LGNet3_ThreeAudios, self).__init__()
    ...
    def forward(self, anchor_waveform, pos_waveform, neg_waveform):
        ...
        neg_waveform = neg_waveform.contiguous().view(neg_waveform.size(0), -1)
